            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 space-y-5 theme-athlete:bg-slate-800 theme-athlete:border-slate-700">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={handlers.handleLogout} className="px-3 py-2 bg-red-500 border border-red-500 text-white rounded-lg hover:bg-red-600 flex items-center gap-2 text-sm font-semibold">
